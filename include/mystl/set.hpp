/**
 * @file set.hpp
 * @brief Set container implementation for mySTL
 * @brief mySTL集合容器实现
 * 
 * This file implements the set container based on red-black tree.
 * Set is an associative container that contains a sorted set of unique objects.
 * 
 * 本文件基于红黑树实现集合容器。
 * Set是一个关联容器，包含一组已排序的唯一对象。
 * 
 * @author shensjt
 * @date 2026-03-29
 */
...
public:
     ...
     * @brief 拷贝构造函数
     * 
     * @param other Another set to copy from
     * @param other 要拷贝的另一个集合
     */
     ...
     * @brief 移动构造函数
     * 
     * @param other Another set to move from
     * @param other 要移动的另一个集合
     */
     ...
     * @param other Another set to copy from
     * @param other 要拷贝的另一个集合
     * @return set& Reference to this set
     * @return set& 此集合的引用
     */
     ...
     * @brief 获取元素数量
     * 
     * @return size_type Number of elements in the set
     ...
     * @param key 要删除元素的键
     * @return size_type Number of elements erased (0 or 1 for set)
     * @return size_type 删除的元素数量（对于set为0或1）
     */
     ...
     * @brief 与另一个集合交换内容
     * 
     * @param other Another set to swap with
     * @param other 要交换的另一个集合
     */
     ...
     * @param key 要计数的键值
     * @return size_type Number of elements with the key (0 or 1 for set)
     * @return size_type 具有该键的元素数量（对于set为0或1）
     */
    ...
    /**
     * @brief Merge another set into this set
     * @brief 将另一个集合合并到此集合中
     * 
     * @param source Source set to merge from
     * @param source 要合并的源集合
     */
    ...
    /**
     * @brief Merge another set into this set (rvalue version)
     * @brief 将另一个集合合并到此集合中（右值版本）
     * 
     * @param source Source set to merge from
     * @param source 要合并的源集合
     */
     ...
     * @return 如果集合不相等返回true，否则返回false
     */
    bool operator!=(const set& other) const {
        return !(*this == other);
    }
     ...
     * @param other Another set to compare with
     * @param other 要比较的另一个集合
     * @return true if this set is lexicographically less than other, false otherwise
     * @return 如果此集合字典序小于另一个集合返回true，否则返回false
     */
    bool operator<(const set& other) const {
        return tree_ < other.tree_;
    }
     ...
     * @param other Another set to compare with
     * @param other 要比较的另一个集合
     * @return true if this set is lexicographically less than or equal to other, false otherwise
     * @return 如果此集合字典序小于等于另一个集合返回true，否则返回false
     */
    bool operator<=(const set& other) const {
        return !(other < *this);
    }
     ...
     * @param other Another set to compare with
     * @param other 要比较的另一个集合
     * @return true if this set is lexicographically greater than other, false otherwise
     * @return 如果此集合字典序大于另一个集合返回true，否则返回false
     */
    bool operator>(const set& other) const {
        return other < *this;
    }
     ...
     * @param other Another set to compare with
     * @param other 要比较的另一个集合
     * @return true if this set is lexicographically greater than or equal to other, false otherwise
     * @return 如果此集合字典序大于等于另一个集合返回true，否则返回false
     */
    bool operator>=(const set& other) const {
        return !(*this < other);
    }
